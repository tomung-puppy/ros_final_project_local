...
from src.domains.robots.robot_repository import IRobotRepository
from src.infrastructure.database.repositories.mysql_robot_repository import MySQLRobotRepository

from src.domains.tasks.task_repository import ITaskRepository
from src.infrastructure.database.repositories.mysql_task_repository import MySQLTaskRepository

# --- Communication Instances ---
from src.infrastructure.communication.protocols import IRobotCommunicator
from src.infrastructure.communication.robot_communicator import MockRobotCommunicator

# --- Core Service Instances ---
from src.core_layer.ai_inference.inference_service import AIInferenceService
from src.core_layer.office_iot.iot_controller import IoTController
from src.core_layer.fleet_management.fleet_manager import FleetManager
from src.core_layer.task_management.task_manager import TaskManager
